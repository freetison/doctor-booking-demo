...
namespace Api.Test.Common.Exceptions;
    ...
    {
        private const string DEFAULT_MESSAGE = "Resource not found";
        private const string CUSTOM_MESSAGE = "custom message";
        private const int EXPECTED_ERROR_CODE = (int)HttpStatusCode.NotFound;
        ...
        {
            // Arrange & Act
            _defaultConstructorException = new NotFoundException();
            _customMessageConstructorException = new NotFoundException(CUSTOM_MESSAGE);
        }
